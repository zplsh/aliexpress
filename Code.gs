...
query += '         , banner_id\n'
query += '         , MAX(country_name) AS country_name\n'
query += '         , date\n'
...
query += '               , country_name             AS country_name\n'
query += '               , date\n'
query += '               , clicks\n'
query += '               , CASE\n'
...
query += '     , h.country_name                                                                                          AS country_name\n'
...
query += '     , CASE\n'
query += '           WHEN h.date < \'2019-12-26\' THEN COALESCE(h.purchases * 21, 0)\n'
query += '           ELSE CASE\n'
query += '                    WHEN h.date >= \'2019-12-26\'  AND h.date < \'2020-01-01\'\n'
query += '                        THEN COALESCE(h.purchases::numeric * 31, 0)\n'
query += '                    ELSE\n'
query += '                        CASE\n'
query += '                            WHEN h.date > \'2020-01-01\' AND LOWER(h.country_name) IN (\'russian federation\', \'azerbaijan\')\n'
query += '                                THEN COALESCE(h.purchases::numeric * 19.95, 0)\n'
query += '                            ELSE CASE\n'
query += '                                     WHEN h.date > \'2020-01-01\' AND LOWER(h.country_name) IN\n'
query += '                                                                    (\'kazakhstan\', \'uzbekistan\', \'tajikistan\',\n'
query += '                                                                     \'armenia\', \'belarus\', \'kyrgyzstan\', \'moldova\')\n'
query += '                                         THEN COALESCE(h.purchases::numeric * 13.3, 0)\n'
query += '                                     ELSE 0 END\n'
query += '                            END\n'
query += '               END\n'
query += '    END                                                                                                        AS revenue_usd\n'
query += '     , CASE\n'
query += '           WHEN h.date < \'2019-12-26\' THEN COALESCE(h.purchases::numeric * 21 - m.costs, 0)\n'
query += '           ELSE CASE WHEN h.date >= \'2019-12-26\' AND h.date < \'2020-01-01\' THEN COALESCE(h.purchases::numeric * 31 - m.costs, 0)\n'
query += 'ELSE CASE\n'
query += '                             WHEN h.date >= \'2019-12-26\'\n'
query += '                                 THEN COALESCE(h.purchases::numeric * 31, 0)\n'
query += '                             ELSE\n'
query += '                                 CASE\n'
query += '                                     WHEN h.date > \'2020-01-01\' AND\n'
query += '                                          LOWER(h.country_name) = \'russian federation\'\n'
query += '                                         THEN COALESCE(h.purchases::numeric * 19.95 - m.costs, 0)\n'
query += '                                     ELSE CASE\n'
query += '                                              WHEN h.date > \'2020-01-01\' AND LOWER(h.country_name) IN\n'
query += '                                                                             (\'kazakhstan\', \'uzbekistan\', \'tajikistan\',\n'
query += '                                                                              \'armenia\', \'belarus\', \'kyrgyzstan\',\n'
query += '                                                                              \'moldova\')\n'
query += '                                                  THEN COALESCE(h.purchases::numeric * 13.3 - m.costs, 0)\n'
query += '                                              ELSE 0 END\n'
query += '                                     END\n'
query += '                        END\n'
query += 'END END AS profit\n'
query += '     , CASE\n'
